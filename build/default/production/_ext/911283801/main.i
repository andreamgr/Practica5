...
# 10 "../Practica5.X/main.c" 2

# 1 "../Practica5.X/LCD_lib.h" 1
# 17 "../Practica5.X/LCD_lib.h"
void LCD_Init(void);
void LCD_Comando(unsigned char cmd);
void LCD_XY(int x,int y);
void LCD_Cadena(const char *);
void LCD_Data(char);
# 11 "../Practica5.X/main.c" 2

# 1 "../Practica5.X/conf.h" 1
# 12 "../Practica5.X/main.c" 2
